...
/* ----------------------------------------------------------------------
 * Title:        adi_sharcfx_convolve_wrapper_s8.c
                                            ...
                                            int8_t *output_data)
{
        ...
        (filter_dims->h == 1) && (conv_params->dilation.w == 1 && conv_params->dilation.h == 1))
    {
        ...
        {
            return adi_sharcfx_convolve_1x1_s8_fast(ctx,
                                            conv_params,
                                            quant_params,
                                            input_dims,
                                            input_data,
        ...
        {
            return adi_sharcfx_convolve_1x1_s8(ctx,
                                       conv_params,
                                       quant_params,
                                       input_dims,
                                       input_data,
    ...
    {
        return adi_sharcfx_convolve_s8(ctx,
                               conv_params,
                               quant_params,
                               input_dims,
                               input_data,
                                                ...
                                                const nn_dims *output_dims)
{
        ...
        (filter_dims->h == 1) && (conv_params->dilation.w == 1 && conv_params->dilation.h == 1))
    {
        if ((conv_params->stride.w == 1) && (conv_params->stride.h == 1))
        {
            return adi_sharcfx_convolve_1x1_s8_fast_get_buffer_size(input_dims);
        }
        else
        {
            return 0;
    ...
    {
        return adi_sharcfx_convolve_s8_get_buffer_size(input_dims, filter_dims);
    }
}
