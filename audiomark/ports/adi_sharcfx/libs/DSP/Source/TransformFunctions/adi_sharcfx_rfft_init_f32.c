/* ----------------------------------------------------------------------
 * Title:        adi_sharcfx_rfft_init_f32.c
...
/**
  ...
  @deprecated    Do not use this function. It has been superceded by \ref adi_sharcfx_rfft_fast_init_f32 and will be removed in the future.
  ...
  uint32_t bitReverseFlag)
{
  ...
  adi_sharcfx_status status = ADI_SHARCFX_MATH_ARGUMENT_ERROR;
  ...
  /*  Initialise the default arm status */
  status = ADI_SHARCFX_MATH_SUCCESS;
  ...
  if (S->ifftFlagR)
  {
    ...
    adi_sharcfx_cfft_radix4_init_f32(S->pCfft, S->fftLenBy2, 1U, 0U);
  }
  else
  {
    /* Initializes the CFFT Module for fftLenreal/2 length */
    adi_sharcfx_cfft_radix4_init_f32(S->pCfft, S->fftLenBy2, 0U, 0U);
  }
